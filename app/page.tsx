    ...
    >
      ...
      <header
        className={`fixed w-full z-40 transition-all duration-300 ${
          scrollY > 50 ? "backdrop-blur-md py-3" : "bg-transparent py-5"
        }`}
        style={{
          backgroundColor:
            scrollY > 50 ? `${colors.backgrounds.blackest}e6` : "transparent",
        }}
      >
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          >
            {isMenuOpen ? (
              <X size={24} style={{ color: colors.primary.yellow }} />
            ) : (
              <Menu size={24} style={{ color: colors.primary.yellow }} />
            )}
          </motion.button>
        </div>
      </header>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <p
                          ...
                          style={{ color: colors.metallics.steel }}
                        >
                          Use for titles, headings, and UI elements
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p
                          ...
                          style={{ color: colors.metallics.chrome }}
                        >
                          Clean, modern text for readable content
                        </p>
                        <p
                          className="text-xs mt-2"
                          style={{ color: colors.metallics.steel }}
                        >
                          Use for paragraphs and descriptions
                        </p>
                      </div>
                    </div>
                  </div>
